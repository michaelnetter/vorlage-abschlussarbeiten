...
% --- Sprachspezifische Stile (erben von hsxbase) -----------------
\lstdefinestyle{java}{style=hsxbase, language=Java}     % Bei Bedarf anpassen
\lstdefinestyle{python}{style=hsxbase, language=Python} 
\lstdefinestyle{sql}{style=hsxbase, language=SQL}       
\lstdefinestyle{bash}{style=hsxbase, language=bash}

% Standardstil für alle Listings ohne expliziten style=-Parameter:
\lstset{style=hsxbase}
