...
\usepackage{csquotes}
\MakeOuterQuote{"}   % "Text" → „Text" (ngerman)
...
\definecolor{lst_rule}   {RGB}{150, 150, 150}   % Randlinie
\definecolor{lst_bg}     {RGB}{245, 245, 245}   % Hintergrundfarbe
...
% Optionen:
%   toc   – Anhang im Inhaltsverzeichnis als eigener Eintrag
%   page  – eigene Trennseite "Anhang" vor den Anhangkapiteln
%   title – Kapiteltitel erhalten automatisch den Präfix "Anhang"
% Verwendung: \begin{appendices} ... \end{appendices}
...
% Einzelne Zeilen am Seitenanfang oder -ende vermeiden:
\widowpenalty  = 10000   % letzte Zeile eines Absatzes allein am Seitenanfang
\clubpenalty   = 10000   % erste Zeile eines Absatzes allein am Seitenende
\displaywidowpenalty = 10000  % gleiches für Zeilen vor Gleichungen
...
{%
  ...
  Hochschule erfragen und diesen Text ersetzen.}
...
\begin{figure}[htbp]
  ...
  \begin{subfigure}[b]{0.48\textwidth}
    ...
    \label{fig:gosper}
  \end{subfigure}
  \caption{Zwei fraktale Kurven als Beispiel für zweiteilige Abbildungen.}
  \label{fig:fraktale}
\end{figure}
...
\label{sec:anführungszeichen}

Für Text in \enquote{Anführungszeichen} sollte der enquote-Befehl genutzt werden.
...
% ============================================================
%  ANHANG  (vor \backmatter, damit Kapitel A, B, C … nummeriert)
% ============================================================
\begin{appendices}
